...
From [`omer-metin/skills-for-antigravity`](https://github.com/omer-metin/skills-for-antigravity/tree/main/skills/typography), under the Apache 2.0 license in `LICENSE`. This attribution line is the only change; the references are unmodified.
