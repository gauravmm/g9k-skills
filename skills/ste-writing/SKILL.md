...
By Ege Çelebi, from [woosal1337/blog](https://github.com/woosal1337/blog/tree/main/videos/ep01-the-cure-for-ai-slop). MIT, see LICENSE in this directory.
...
For a file, `python3 .claude/skills/ste-writing/ste_lint.py FILE` scores the mechanical subset (violations per 100 words, lower is cleaner). The delta before and after the rewrite is the signal, not the absolute number.
